...
export default class {  
    ...
    constructor(item_num, item_name, item_price, item_image, item_content) {
        ...
        // this.product_number = item_num;
        // this.product_name = item_name;
        // this.product_price = item_price;
        // this.product_image = item_image;
        // this.product_content = item_content;

        this.n_cart = Main;
        let user_id = this.n_cart.getCookie()[1];
            ...
            if(e.target && e.target.className == 'buy_now_btn') {
                ...
                if (order_quantity != 0) {
                    ...
                    .then(buy_now_checkout_cart => {
                        ...
                        if(user_id == 'GUEST') {
                            history.pushState(null, null, `/shop/checkout/GUEST/item_num=${item_num}`); // url change
                            ...
                            history.pushState(null, null, `/shop/checkout/member/item_num=${item_num}`); // url change
...
*/
    ...
    getHtml(item_image, item_num, item_name, item_price, item_content) {  
        ...
        return `
            <div id="online_item_detail_container" class="online_item_detail_container" itemid=${item_num}>
                ...
                <div id="online_item_detail_name" class="online_item_detail_name">                    
                    ${item_name}               
                </div>
                <div id="online_item_detail_price" class="online_item_detail_price">                    
                    $${parseFloat(item_price).toFixed(2)}
                </div>

                <div id="online_item_detail_description" class="online_item_detail_description">                    
                    ${item_content}
                </div>

                <div id="online_item_detail_quantity" class="online_item_detail_quantity"> 
                ...
                <button id="add_cart_btn" class="add_cart_btn" title="Add item">Add Cart</button>
                <button id="buy_now_btn" class="buy_now_btn" title="Buy It Now">BUY IT NOW</button>
                <br><br><br>
    ...
    setAddItemHtml(item_name, order_quantity) {
        return`
        <div id="check_go_cart" class="check_go_cart">
        <h2>You added ${item_name} for ${order_quantity} items.</h2>
        
        <button id="go_cart" class="check_out">GO Cart</button><br>
        <button id="check_out" class="check_out">Check Out</button><br>
