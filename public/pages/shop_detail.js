            ...
            if(e.target && e.target.id == 'buy_now_btn') {
                ...
                .then(buy_now_checkout_cart => {
                    ...
                    if(user_id == 'GUEST') {
                        ...
                        this.n_cart.c_item_image = "http://localhost:8080"+buy_now_checkout_cart[0].image;
                        this.n_cart.c_item_name = buy_now_checkout_cart[0].name;
                        this.n_cart.c_item_no = buy_now_checkout_cart[0].prodnum;
                        this.n_cart.c_item_price = buy_now_checkout_cart[0].price_sell;
                        this.n_cart.c_item_quantity = order_quantity;
                        
        
                        guest_buy_now_checkout_cart.push(this.n_cart);
